...
class ProjectTest extends TestCase {
	...
	public function testGetVersion__hotfix(): void {
	...
	public function testGetVersion__support(): void {
		$rootPackage = $this->getMockBuilder(RootPackageInterface::class)->getMock();
		$rootPackage->method('getName')->willReturn('sitepark/foo');
		/** @var RootPackageInterface $rootPackage */
	...
	public function testGetVersion__develop(): void {
		$rootPackage = $this->getMockBuilder(RootPackageInterface::class)->getMock();
		$rootPackage->method('getName')->willReturn('sitepark/foo');
		/** @var RootPackageInterface $rootPackage */
	...
	public function testGetVersion__majorBranchAlias(): void {
		$rootPackage = $this->getMockBuilder(RootPackageInterface::class)->getMock();
		$rootPackage->method('getName')->willReturn('sitepark/foo');
